...
# else:
#     EDT = np.load('./EDT.npy')
vol1 = np.load('/home/yunfanz/Data/Kaggle/LungCan/stage1_processed/sp2_waterseg/train/0c0de3749d4fe175b7a5098b060982a1.npy')
# Read volume
#vol1 = np.load(io.load_data_file('volume/stent.npz'))['arr_0']
# vol2 = np.load(io.load_data_file('brain/mri.npz'))['data']
# vol2 = np.flipud(np.rollaxis(vol2, 1))

vol2 = np.load('/home/yunfanz/Data/Kaggle/LungCan/stage1_processed/sp2_waterseg/train/0c98fcb55e3f36d0c2b6507f62f4c5f1.npy')
vol1 = vol1[0,0,0]-vol1
vol2 = vol2[0,0,0]-vol2
# Prepare canvas
...
volume2 = scene.visuals.Volume(vol2, parent=view.scene, threshold=0.4,
                               emulate_texture=emulate_texture)
...
#translucent_cmaps = cycle([TransGrays()])
